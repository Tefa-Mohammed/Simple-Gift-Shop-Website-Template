(function () {
  ...
  let verticalProducts = Array.from(document.querySelectorAll('.vertical'));
  let verticalIcon = document.getElementById('grip');
  ...
  listIcon.addEventListener('click', function () {
    verticalProducts.forEach((products) => {
      products.style.opacity = '0';
    })
    listProducts.style.opacity = '1';
    rateSection.classList.add('rateMargin');
  })
  verticalIcon.addEventListener('click', function () {
    verticalProducts.forEach((products) => {
      products.style.opacity = '1';
      products.style.transition = 'all 1s';
    })
    listProducts.style.opacity = '0';
    rateSection.classList.remove('rateMargin');
  })
